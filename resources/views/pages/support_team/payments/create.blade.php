            ...
            <div class="row">
                <div class="col-md-6">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="title" value="{{ old('title') }}" required type="text"
                                    class="form-control" placeholder="Eg. School Fees">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="method" class="col-lg-3 col-form-label font-weight-semibold">Payment
                                Method</label>
                            <div class="col-lg-9">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#my_class_id').on('change', function() {
                ...
                $.ajax({
                    url: '/ajax/get_students_by_class/' + selectedClassId,
                    type: 'GET',
                    // dataType: 'json',
                    success: function(data) {                        
                        ...
                        $.each(data, function(index, student) {
                            studentSelect.append('<option value="' + student.user_id + '">' + student.user.name + '</option>');
                        });
                    },
