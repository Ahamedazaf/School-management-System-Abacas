...
<div class="card">
    ...
    <form id="ajax-reg" method="post" enctype="multipart/form-data" class="wizard-form steps-validation"
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select onchange="getLGA(this.value)" required data-placeholder="Choose.."
                        ...
                        <option {{ (old('state_id')==$st->id ? 'selected' : '') }} value="{{ $st->id }}">{{ $st->name }}
                        </option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="select form-control" id="bg_id" name="bg_id" data-fouc
                            ...
                            <option {{ (old('bg_id')==$bg->id ? 'selected' : '') }} value="{{ $bg->id }}">{{ $bg->name
                                }}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-md-3 d-none">
                    <div class="form-group">
                        ...
                        <select data-placeholder="Choose..." name="my_parent_id" id="my_parent_id"
                            ...
                            <option {{ (old('my_parent_id')==Qs::hash($p->id)) ? 'selected' : '' }} value="{{
                                Qs::hash($p->id) }}">{{ $p->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
        ...
        <button type="submit" class="btn btn-primary" style="float: right; margin: 20px;">Submit &nbsp;&nbsp;<i
